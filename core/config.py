...
__C.YOLO.CLASSES = 'data/classes/garbage.names'
__C.YOLO.ANCHORS = 'data/anchors/yolo_anchors.txt' # yolov3/5 : yolo_anchors.txt; yolov4 : yolov4_anchors.txt
...
__C.YOLO.ORIGINAL_WEIGHT = 'checkpoint/yolov3_garbage.ckpt'
__C.YOLO.DEMO_WEIGHT = 'checkpoint/yolov3_garbage_demo.ckpt'
